          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        ...
                        array('label'=>'Personal <span class="caret"></span>', 'url'=>array('/personal/index'),'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"our home page"), 
                        'items'=>array(
                        ...
                        array('label'=>'Turista <span class="caret"></span>', 'url'=>array('/turista/index'),'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"our home page"), 
                        'items'=>array(
                        ...
                        array('label'=>'Proveedor <span class="caret"></span>', 'url'=>array('/proveedor/index'),'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"our home page"), 
                        'items'=>array(
                        ...
                        array('label'=>'Ruta <span class="caret"></span>', 'url'=>array('/ruta/index'),'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"our home page"), 
                        'items'=>array(
                            array('label'=>'admin ruta', 'url'=>array('/ruta/admin')),
                            array('label'=>'crear ruta', 'url'=>array('/ruta/create')),
                            array('label'=>'localidad', 'url'=>array('/localidad/index')),
                            
                        )),

                        array('label'=>'Compras <span class="caret"></span>', 'url'=>array(''),'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"our home page"), 
                        'items'=>array(
